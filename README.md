...
При первом посещении вы увидите только кнопку входа — таблица постов и статистика скрыты до авторизации:

1. Нажмите кнопку **"Войти через ВКонтакте"**
2. Разрешите приложению доступ к вашему профилю и сообществам
3. После авторизации вы увидите своё имя и аватар в шапке сайта, а также таблицу постов

> ⚠️ **Важно**: 
> - Доступ к просмотру постов и генерации контента имеют **только авторизованные пользователи**
> - Для доступа к кнопке генерации вы должны быть **администратором** хотя бы одного сообщества ВКонтакте
> - Без авторизации отображается сообщение "Требуется авторизация для просмотра постов"
